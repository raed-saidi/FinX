...
[![ZenML](https://img.shields.io/badge/ZenML-Pipelines-5B21B6.svg)](https://www.zenml.io/)
[![Qdrant](https://img.shields.io/badge/Qdrant-VectorDB-DC244C.svg)](https://qdrant.tech/)
[![Alpaca](https://img.shields.io/badge/Alpaca-Trading-0B5FFF.svg)](https://alpaca.markets/)
[![Docker](https://img.shields.io/badge/Docker-Containerized-2496ED.svg?logo=docker&logoColor=white)](https://www.docker.com/)
[![CI](https://github.com/raed-saidi/FinX/actions/workflows/ci.yml/badge.svg)](https://github.com/raed-saidi/FinX/actions/workflows/ci.yml)
...
- **Repository Hygiene**: Secrets and generated artifacts excluded from version control
...
- **GitHub Actions**: Automated testing and container build validation
...
- **Local/Self-Hosted Runtime**: Backend + frontend + Qdrant
- **MLflow Tracking Server**: Experiment tracking + model registry (port 5000)
...
4. **Experiment Tracking**: MLflow logs params, metrics, and model artifacts
5. **Vector Search**: Qdrant finds similar historical market conditions
6. **API Layer**: FastAPI serves predictions via REST + WebSocket
7. **Frontend**: Next.js renders real-time dashboard with live updates
...
Hosted cloud deployment is intentionally disabled to keep infrastructure costs at zero.
...
**Built as a production-focused AI trading platform portfolio project** | Star ⭐ this repo if you found it useful!
