...
const DEMO_RECOMMENDATIONS = [
  { asset: 'NVDA', signal: 0.052, weight_pct: 22.5, direction: 'LONG' as const, current_price: 512.45, confidence: 0.78, reasoning: 'Strong AI momentum with positive technical indicators and upward trend.', weight: 0.225, dollars: 0, shares: 0, predicted_return_pct: 5.2, last_updated: new Date().toISOString() },
  { asset: 'MSFT', signal: 0.038, weight_pct: 18.0, direction: 'LONG' as const, current_price: 445.32, confidence: 0.74, reasoning: 'Cloud services growth and consistent performance metrics.', weight: 0.180, dollars: 0, shares: 0, predicted_return_pct: 3.8, last_updated: new Date().toISOString() },
  { asset: 'AAPL', signal: 0.029, weight_pct: 16.0, direction: 'LONG' as const, current_price: 225.67, confidence: 0.71, reasoning: 'Bullish technical setup with strong fundamentals.', weight: 0.160, dollars: 0, shares: 0, predicted_return_pct: 2.9, last_updated: new Date().toISOString() },
  { asset: 'TSLA', signal: 0.024, weight_pct: 14.5, direction: 'LONG' as const, current_price: 278.78, confidence: 0.68, reasoning: 'Delivery numbers beat expectations with positive momentum.', weight: 0.145, dollars: 0, shares: 0, predicted_return_pct: 2.4, last_updated: new Date().toISOString() },
  { asset: 'GOOGL', signal: 0.019, weight_pct: 12.0, direction: 'LONG' as const, current_price: 189.54, confidence: 0.65, reasoning: 'AI investments and advertising revenue showing strength.', weight: 0.120, dollars: 0, shares: 0, predicted_return_pct: 1.9, last_updated: new Date().toISOString() },
  { asset: 'AMZN', signal: 0.015, weight_pct: 10.0, direction: 'LONG' as const, current_price: 225.89, confidence: 0.62, reasoning: 'Cloud services expansion with e-commerce resilience.', weight: 0.100, dollars: 0, shares: 0, predicted_return_pct: 1.5, last_updated: new Date().toISOString() },
  { asset: 'SPY', signal: 0.008, weight_pct: 7.0, direction: 'NEUTRAL' as const, current_price: 598.23, confidence: 0.58, reasoning: 'Broad market exposure with moderate signal strength.', weight: 0.070, dollars: 0, shares: 0, predicted_return_pct: 0.8, last_updated: new Date().toISOString() },
];
